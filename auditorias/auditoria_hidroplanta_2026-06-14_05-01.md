...
- **Tabla:** mvp_cierre_detalle
  - Columnas: id, cierre_id, caja_id, saldo_inicial, saldo_final, created_at, updated_at, total_ingresos, total_egresos, monto_dividendos, monto_transferido_tesoreria, porc_ganancia_aplicado
