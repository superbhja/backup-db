...
- **Tabla:** mvp_rendiciones
  - Columnas: id, caja_id, socio_id, periodo_id, saldo_libro, efectivo_declarado, faltante, operacion_liquidacion_id, usuario_id, fecha, created_at, updated_at, operacion_entrega_id
...
- fn_render_rn
- fn_render_rn_jsonb
- fn_rendiciones_periodo
- fn_rendir_caja_delegada
- fn_rendir_dia
...
- idx_mvp_rendiciones_operacion_entrega_id (mvp_rendiciones) [operacion_entrega_id]
...
| Tabla | Registros |
|--------|-----------|
| mvp_comprobante_linea | 602 |
| mvp_ventas_detalle | 567 |
| mvp_egresos_auditoria | 372 |
| mvp_operacion_caja | 361 |
| mvp_comprobante | 279 |
| mvp_ventas | 244 |
| mvp_egresos | 62 |
