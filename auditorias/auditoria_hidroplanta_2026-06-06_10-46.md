...
- **Tabla:** mvp_cierre_detalle
  - Columnas: id, cierre_id, caja_id, saldo_inicial, saldo_final, created_at, updated_at
- **Tabla:** mvp_cierres
  - Columnas: id, fecha_inicio, fecha_fin, estado, created_at, updated_at
- **Tabla:** mvp_clientes
...
- **Tabla:** mvp_operacion_caja
  - Columnas: id, tipo_operacion_id, fecha, usuario_id, estado, caja_origen_id, caja_destino_id, tercero_id, tipo_tercero, referencia_externa, observaciones, created_at, updated_at, documento_tipo, documento_id, operacion_relacionada_id
- **Tabla:** mvp_productos
  - Columnas: id, nombre, precio_lista, activo, created_at, updated_at
...
- **Tabla:** mvp_tipo_operaciones
  - Columnas: id, codigo, nombre, descripcion, modulo, ambito, cantidad_mov, usa_caja_origen, usa_caja_destino, usa_tercero, tipo_tercero, requiere_documento, tipo_documento, rpc_handler, roles_permitidos, metadata, activa, orden, created_at, updated_at
- **Tabla:** mvp_users
...
- mvp_productos productos_insert_admin (Schema=public)
...
- mvp_ventas ventas_access_socio (Schema=public)
- mvp_ventas ventas_access_socio_pool (Schema=public)
...
| Tabla | Registros |
|--------|-----------|
| mvp_reglas_negocio | 40 |
| mvp_movimientos_caja | 26 |
| mvp_operacion_caja | 16 |
| mvp_ventas_detalle | 12 |
| mvp_tipo_operaciones | 11 |
| mvp_ventas | 10 |
| mvp_cajas | 7 |
| mvp_proveedores | 6 |
| mvp_users | 5 |
