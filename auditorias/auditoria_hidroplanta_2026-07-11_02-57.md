...
- **Tabla:** mvp_clientes
  - Columnas: id, razon_social, cuit, created_at, updated_at, activo, creado_por
- **Tabla:** mvp_ctacte
  - Columnas: id, socio_id, operacion_id, tipo_mov_ctacte, monto_debe, monto_haber, fecha, descripcion, created_at, updated_at, afecta_saldo
- **Tabla:** mvp_egresos
...
- **Tabla:** mvp_users
  - Columnas: id, email, rol, cliente_id, nombre, activo, created_at, updated_at, telefono, rol_tesorero
- **Tabla:** mvp_ventas
...
| Tabla | Registros |
|--------|-----------|
| mvp_ventas_detalle | 167 |
| mvp_movimientos_caja | 102 |
| mvp_operacion_caja | 100 |
| mvp_ventas | 77 |
| mvp_reglas_negocio | 47 |
| mvp_proveedores | 24 |
| mvp_clientes | 20 |
| mvp_productos | 15 |
| mvp_tipo_operaciones | 15 |
| mvp_egresos | 14 |
| mvp_cajas | 9 |
| mvp_users | 6 |
| mvp_cierre_detalle | 5 |
| mvp_rendiciones | 4 |
| mvp_repartidores | 4 |
| mvp_socios | 4 |
| mvp_ctacte | 3 |
| mvp_periodo | 2 |
| mvp_cierre_resumen | 1 |
| mvp_cierres | 1 |
| mvp_system_status | 1 |
